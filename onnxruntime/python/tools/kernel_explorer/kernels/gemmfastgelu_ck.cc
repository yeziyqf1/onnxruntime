...
#include "core/providers/rocm/tunable/gemmfastgelu_ck.cuh"
...
class CKGemmFastGelu : public IKernelExplorer {
 public:
  CKGemmFastGelu(BlasOp opa, BlasOp opb,
                 ...
                 DeviceArray& bias0, DeviceArray& bias1,
                 double beta,
    ...
    params_.ldb = ldb;
    params_.bias0 = static_cast<T*>(bias0.ptr());
    params_.bias1 = static_cast<T*>(bias1.ptr());
    params_.beta = beta;
